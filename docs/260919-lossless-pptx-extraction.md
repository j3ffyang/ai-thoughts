...
![Blueprint-style infographic of the lossless PPTX-to-Markdown pipeline: the source → extract → audit flow, the three content classes, the five-point audit, and why the work stays local](../imgs/260919-lossless-pptx-extraction.png)
